...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(lv_font_chinese_14) LV_FONT_DECLARE(lv_font_chinese_18) LV_FONT_DECLARE(lv_font_chinese_20) LV_FONT_DECLARE(lv_font_chinese_30) LV_FONT_DECLARE(lv_font_chinese_34) LV_FONT_DECLARE(lv_font_chinese_36) LV_FONT_DECLARE(lv_font_han_sans_regular_30) LV_FONT_DECLARE(lv_font_han_sans_regular_32) LV_FONT_DECLARE(lv_font_han_sans_bold_number_only_86) LV_FONT_DECLARE(lv_font_chinese_24)
